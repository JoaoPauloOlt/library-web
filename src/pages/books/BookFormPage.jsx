...
export default function BookFormPage() {
    ...
    const handleIsbnChange = (e) => {
        ...
        setForm((current) => ({ ...current, isbn, coverUrl: current.coverUrl || googleBooksCover(isbn) }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            await api.post("/books", { ...form, quantity, coverUrl: form.coverUrl || null });
            navigate("/books");
        ...
        <div className="page-content">
            ...
            <form onSubmit={handleSubmit} className="card">
                <div className="form-grid">
                    ...
                    <button className="btn-primary" disabled={loading}>{loading ? "Salvando..." : "Salvar Livro"}</button>
                </div>
            </form>
        </div>
    );
